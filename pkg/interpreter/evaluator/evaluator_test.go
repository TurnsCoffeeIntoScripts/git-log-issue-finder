...
func TestStringInequalityOperator(t *testing.T) {
	input := `"abc" != "abc"`
...
func TestHashLiterals(t *testing.T) {
	...
	if !ok {
		t.Errorf("Eval didn't return Hash. got=%T (%+v)", evaluated, evaluated)
	}
...
func TestRepoExpression(t *testing.T) {
	tests := []struct {
		input    string
		expected string
	}{
		{`set repopath "."; whichRepo();`, `.`},
		{`set repopath "abc"; whichRepo();`, `abc`},
	}
